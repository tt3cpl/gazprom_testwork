...
export type UseChoiceGroupIndexedParams<MULTIPLE extends boolean = false, IS_NULLABLE_VALUE extends boolean = false, EVENT = React.MouseEvent<HTMLDivElement, MouseEvent>> = {
