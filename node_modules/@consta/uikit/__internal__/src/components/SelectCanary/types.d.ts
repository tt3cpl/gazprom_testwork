...
export type SelectPropGetItemGroupKey<ITEM> = (item: ITEM) => string | number | undefined;
export type SelectPropGetItemDisabled<ITEM> = (item: ITEM) => boolean | undefined;
...
export type SelectPropOnChange<ITEM, MULTIPLE extends boolean> = (value: (MULTIPLE extends true ? ITEM[] : ITEM) | null, props: {
    e: React.SyntheticEvent;
}) => void;
export type SelectPropValue<ITEM, MULTIPLE extends boolean> = (MULTIPLE extends true ? ITEM[] : ITEM) | null | undefined;
export type SelectPropRenderItem<ITEM> = (props: RenderItemProps<ITEM>) => React.ReactNode | null;
export type SelectPropRenderValue<ITEM, MULTIPLE> = MULTIPLE extends true ? (props: {
    value: ITEM[];
    getRemove: (item: ITEM) => (e: React.SyntheticEvent<Element, Event>) => void;
}) => React.ReactNode | null : (props: {
    value: ITEM;
}) => React.ReactNode | null;
export type SelectPropOnCreate = (label: string, props: {
    e: React.SyntheticEvent;
}) => void;
...
export type SelectPropsInit<ITEM = SelectItemDefault, GROUP = SelectGroupDefault, MULTIPLE extends boolean = false> = PropsWithHTMLAttributesAndRef<{
    'items': ITEM[];
...
export type SelectProps<ITEM = SelectItemDefault, GROUP = SelectGroupDefault, MULTIPLE extends boolean = false> = SelectPropsInit<ITEM, GROUP, MULTIPLE> & (ITEM extends {
