...
declare const tableWithTrafficLightDataRows: {
    ...
    field: string;
    sum: number;
    status: import("react/jsx-runtime").JSX.Element;
    statusOrder: number;
}[];
export declare const tableWithBadgeData: TableProps<(typeof tableWithTrafficLightDataRows)[number]>;
...
export declare const rowsForCustomTagLabelFunction: {
    [CustomIDs.fullName]: string;
    [CustomIDs.yearOfRegistration]: number;
    id: string;
    phone: number;
}[];
