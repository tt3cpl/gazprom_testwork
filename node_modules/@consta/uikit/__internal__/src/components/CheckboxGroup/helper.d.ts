...
export declare const withDefaultGetters: (props: CheckboxGroupProps) => {
    ...
    name?: string;
    direction?: import("./types").CheckboxGroupPropDirection;
    align?: import("./types").CheckboxGroupPropAlign;
    size?: import("./types").CheckboxGroupPropSize;
    view?: import("./types").CheckboxGroupPropView;
    disabled?: boolean;
    className?: string;
