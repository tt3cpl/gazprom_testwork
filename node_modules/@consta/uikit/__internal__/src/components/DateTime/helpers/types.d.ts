...
export type DateTimePropOnChangeRange<TYPE> = TYPE extends CapableRangeType ? (value: DateRange, props: {
    e: React.MouseEvent<HTMLButtonElement>;
}) => void : never;
type LocaleWords = {
    words?: {
...
export type DateTimeComponent = <TYPE extends DateTimePropType = 'date'>(props: DateTimeProps<TYPE>) => React.ReactNode | null;
export type DateTimeTypeComponent<TYPE extends DateTimePropType> = (props: Omit<DateTimeProps<TYPE>, 'type'>) => React.ReactNode | null;
export type HandleSelectDate = (value: Date, props: {
    value: Date;
    e: React.MouseEvent<HTMLButtonElement>;
}) => void;
export {};
