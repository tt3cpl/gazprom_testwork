...
export type BookmarkTabsPropGetItemLabel<ITEM> = (item: ITEM) => string | number | undefined;
export type BookmarkTabsPropGetItemLeftIcon<ITEM> = (item: ITEM) => IconComponent | undefined;
export type BookmarkTabsPropGetItemRightIcon<ITEM> = (item: ITEM) => IconComponent | undefined;
export type BookmarkTabsPropGetItemFixed<ITEM> = (item: ITEM) => boolean | undefined;
export type BookmarkTabsPropGetItemAs<ITEM> = (item: ITEM) => AsTags | undefined;
export type BookmarkTabsPropGetItemRef<ITEM> = (item: ITEM) => React.RefObject<HTMLElement> | undefined;
export type BookmarkTabsPropGetItemAttributes<ITEM> = (item: ITEM) => AsAttributes | undefined;
export type BookmarkTabsPropOnChange<ITEM> = (value: ITEM, params: {
    e: React.MouseEvent;
}) => void;
...
export type BookmarkTabsProps<ITEM = BookmarkTabsItemDefault> = PropsWithHTMLAttributesAndRef<{
    size?: BookmarkTabsPropSize;
    form?: BookmarkTabsPropForm;
    view?: BookmarkTabsPropView;
    items: ITEM[];
