...
export declare const getTabsWrapper: (tabsDirection: TabsDirection, fitMode: TabsPropFitMode) => (<ITEM>({ items, tabsDimensions, tabRefs, getItemKey, getItemChecked, renderItem, onChange, renderItemsList, size, }: import("./types").TabsFitModeWrapperProps<ITEM>) => React.ReactNode | null) | (<ITEM>({ renderItemsList, items, }: import("./types").TabsFitModeWrapperProps<ITEM>) => import("react/jsx-runtime").JSX.Element);
export declare const withDefaultGetters: (props: TabsProps) => {
    getItemKey: import("./types").TabsPropGetItemKey<TabsItemDefault> | undefined;
    ...
    size?: import("./types").TabsPropSize;
    onlyIcon?: boolean;
    view?: import("./types").TabsPropView;
    iconSize?: import("@consta/icons/Icon").IconPropSize;
