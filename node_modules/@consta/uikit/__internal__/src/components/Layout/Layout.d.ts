...
export declare const cnLayout: import("@bem-react/classname").ClassNameFormatter;
export declare const Layout: import("../../utils/types/PropsWithAsAttributes").ComponentWithAs<LayoutProps, "div">;
