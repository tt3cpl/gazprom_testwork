...
export declare const DatePickerFieldTypeDateRange: React.ForwardRefExoticComponent<Omit<import("../DatePickerFieldTypeDate/helpers").DatePickerFieldTypeDateProps, "id" | "onFocus" | "onBlur" | "onChange" | "name" | "value" | "placeholder" | "inputRef" | "leftSide" | "rightSide"> & {
