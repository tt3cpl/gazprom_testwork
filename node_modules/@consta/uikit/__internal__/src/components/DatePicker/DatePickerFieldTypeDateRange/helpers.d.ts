...
export type DatePickerFieldTypeDateRangeProps = Omit<DatePickerFieldTypeDateProps, 'onChange' | 'value' | 'inputRef' | 'leftSide' | 'rightSide' | 'id' | 'onFocus' | 'onBlur' | 'name' | 'placeholder'> & {
