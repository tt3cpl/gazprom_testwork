...
type DatePickerFieldTypeMonthRangePropOnChange = (value: DateRange | null, props: {
    e: Event;
}) => void;
export type DatePickerFieldTypeMonthRangeProps = Omit<DatePickerFieldTypeMonthProps, 'onChange' | 'value' | 'inputRef' | 'leftSide' | 'rightSide' | 'id' | 'onFocus' | 'onBlur' | 'name' | 'placeholder'> & {
