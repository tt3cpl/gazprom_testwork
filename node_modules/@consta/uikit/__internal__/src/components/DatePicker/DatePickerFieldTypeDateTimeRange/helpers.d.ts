...
type DatePickerFieldTypeDateTimeRangePropOnChange = (value: DateRange | null, props: {
    e: Event;
}) => void;
export type DatePickerFieldTypeDateTimeRangeProps = Omit<DatePickerFieldTypeDateTimeProps, 'onChange' | 'value' | 'inputRef' | 'leftSide' | 'rightSide' | 'id' | 'onFocus' | 'onBlur' | 'name' | 'placeholder'> & {
