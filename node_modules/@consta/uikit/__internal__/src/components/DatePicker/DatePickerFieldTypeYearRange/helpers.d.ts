...
type DatePickerFieldTypeYearRangePropOnChange = (value: DateRange | null, props: {
    e: Event;
}) => void;
export type DatePickerFieldTypeYearRangeProps = Omit<DatePickerFieldTypeYearProps, 'onChange' | 'value' | 'inputRef' | 'leftSide' | 'rightSide' | 'id' | 'onFocus' | 'onBlur' | 'name' | 'placeholder'> & {
