...
export type ThemeTogglerPropOnChange<ITEM> = (value: ITEM, props: {
    e: React.MouseEvent;
}) => void;
...
export type ThemeTogglerProps<ITEM = ThemeTogglerItemDefault> = PropsWithHTMLAttributesAndRef<{
...
export type ThemeTogglerComponent = <ITEM>(props: ThemeTogglerProps<ITEM>) => React.ReactNode | null;
