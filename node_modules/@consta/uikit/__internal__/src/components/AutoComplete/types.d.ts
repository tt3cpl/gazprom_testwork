...
export type AutoCompletePropOnChange = (value: string | null, props: {
    e: React.ChangeEvent | React.MouseEvent | React.KeyboardEvent;
    id?: string;
    name?: string;
}) => void;
export type AutoCompleteProps<TYPE extends string, ITEM = AutoCompleteItemDefault, GROUP = AutoCompleteGroupDefault> = {
    items: ITEM[];
    groups?: GROUP[];
