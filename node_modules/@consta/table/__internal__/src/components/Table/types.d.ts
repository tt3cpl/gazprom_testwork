...
export type TableColumn<ROW> = {
    title?: string;
    width?: number | 'auto' | '1fr' | '2fr' | '3fr' | '4fr' | '5fr' | '6fr' | '7fr' | '8fr' | '9fr' | '10fr';
    maxWidth?: number;
    minWidth?: number;
...
export type TableRowMouseEvent<ROW> = (row: ROW, props: {
    e: React.MouseEvent;
}) => void;
...
export type TableComponent = <ROW = TableDefaultRow>(props: TableProps<ROW>) => React.ReactNode | null;
export type TableHeaderProps<ROW = TableDefaultRow> = PropsWithHTMLAttributesAndRef<{
...
export type TableHeaderComponent = <ROW = TableDefaultRow>(props: TableHeaderProps<ROW>) => React.ReactNode | null;
...
export type TableBodyComponent = <ROW>(props: TableBodyProps<ROW>) => React.ReactNode | null;
...
export type TableBodyRootComponent = (props: TableBodyRootProps) => React.ReactNode | null;
export type TableDataProps<ROW = TableDefaultRow> = PropsWithHTMLAttributesAndRef<{
...
export type TableDataComponent = <ROW = TableDefaultRow>(props: TableDataProps<ROW>) => React.ReactNode | null;
export {};
